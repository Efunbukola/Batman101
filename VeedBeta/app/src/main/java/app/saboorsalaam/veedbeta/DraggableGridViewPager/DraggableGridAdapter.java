package app.saboorsalaam.veedbeta.DraggableGridViewPager;
...
import app.saboorsalaam.veedbeta.DynamicGridView.BaseDynamicGridAdapter;
import app.saboorsalaam.veedbeta.R;
import app.saboorsalaam.veedbeta.home_activity;
...
public class DraggableGridAdapter extends BaseDynamicGridAdapter {
    ...
    public DraggableGridAdapter(List<?> items, home_activity callingActivity, int mNumColumns,int item_height) {
        super(callingActivity, items, mNumColumns);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        switch (getItemViewType(position)) {
            case TYPE_CHANNEL:
                ...
                if (convertView == null) {
                    convertView = LayoutInflater.from(getContext()).inflate(R.layout.draggable_gridview_cell_layout, null);
                ...
                holder.build(convertView, callingActivity, position, title, size, thumb, thumb2, cover_title, cover2_title);

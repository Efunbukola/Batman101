package app.saboorsalaam.veedbeta.DynamicGridView;
...
public class DynamicGridView extends GridView {
    ...
    RelativeLayout trash = new RelativeLayout(getContext());
    ...
    private OnPutInTrashListener mPutInTrashListener;
    ...
    private OnItemLongClickListener mLocalLongClickListener = new OnItemLongClickListener() {
        ...
        public boolean onItemLongClick(AdapterView<?> arg0, View arg1, int pos, long id) {
            Log.d("item", "Item long clicked:" + pos);
            ...
            if(mPutInTrashListener !=null)
            {
                //mPutInTrashListener.onDragStarted(5);//****************************Register that drag has started!!!!!
                mPutInTrashListener.onDragStarted(position);
            }
    ...
    private OnItemClickListener mLocalItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            Log.d("item", "Item clicked:" + position);
    ...
    public void setTrashView(RelativeLayout trash)
    {
        this.trash = trash;
    }
    ...
    public void makeGrayScale(int position)
    {
    ...
    public void setOnPutInTrashListener(OnPutInTrashListener trashListener) {
        this.mPutInTrashListener = trashListener;
    }
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (mIsEditMode && isEnabled()) {
                    ...
                    int position = pointToPosition(mDownX, mDownY);
                    int itemNum = position - getFirstVisiblePosition();
                    View selectedView = getChildAt(itemNum); //selected view
                    if (selectedView == null) {
                        return false;
                    } else {
                        selectedView.setScaleX(selectedView.getScaleX()*2);
                        selectedView.setScaleY(selectedView.getScaleY()*2);
            ...
            case MotionEvent.ACTION_UP:
                ...
                int y = Math.round(event.getY()); //When item is dragged and dropped in the trash call Trash Listener
                ...
                //if (x > trash.getLeft() && x < trash.getRight() && y > trash.getTop() && y < trash.getBottom()) {
                //    if (mPutInTrashListener != null) {
                //        this.mPutInTrashListener.onActionDropInTrash(0);
                  //  }
                //}
    ...
    public interface OnPutInTrashListener {

        void onDragStarted(int position);


        void onTouchTrash(int position);
        /**
         * called when view been dropped in trash
         */

        void onActionDropInTrash(int position);

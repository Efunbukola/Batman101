...
//*&^^%$$
//HIDE SYSTEM UI
//DEAL WITH BACK STACK IMAGES NOT SHOWING
//??VIDEO RESTART ON ORIENTATION CHANGER!!
//())@##$%^^

public class youtube_player_activity extends YouTubeBaseActivity implements
        CustomYouTubePlayer.OnFullscreenListener,
        CustomYouTubePlayer.OnInitializedListener,
        CustomYouTubePlayer.PlayerStateChangeListener {

    public static final String EXTRA_VIDEO_ID = "video_id";
    private static final boolean TOAST = false;
    private static final int RECOVERY_DIALOG_REQUEST = 1;
    public static final String GOOGLE_API_KEY = "AIzaSyCLGCJOPU8VVj7daoh5HwXZASnmGoc4ylo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_youtube_player_activity);
    ...
    public void onInitializationSuccess(CustomYouTubePlayer.Provider provider, YouTubePlayer player,
        ...
        if (mAutoRotation) {
            player.addFullscreenControlFlag(
                   CustomYouTubePlayer.FULLSCREEN_FLAG_CONTROL_SYSTEM_UI
                    | CustomYouTubePlayer.FULLSCREEN_FLAG_ALWAYS_FULLSCREEN_IN_LANDSCAPE
                    | CustomYouTubePlayer.FULLSCREEN_FLAG_CUSTOM_LAYOUT);
        } else {
            player.addFullscreenControlFlag(CustomYouTubePlayer.FULLSCREEN_FLAG_CONTROL_ORIENTATION
                    | CustomYouTubePlayer.FULLSCREEN_FLAG_CONTROL_SYSTEM_UI
                    | CustomYouTubePlayer.FULLSCREEN_FLAG_CUSTOM_LAYOUT);
        }
    ...
    public CustomYouTubePlayer.Provider getYouTubePlayerProvider() {
        return mPlayerView;
    }
    ...
    public void onBackPressed() {
        //super.onBackPressed();
        finish();
        //this.overridePendingTransition(R.anim.slide_down,R.anim.stay);
    }

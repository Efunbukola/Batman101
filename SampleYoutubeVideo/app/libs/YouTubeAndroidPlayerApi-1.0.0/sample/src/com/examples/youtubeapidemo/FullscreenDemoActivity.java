...
public class FullscreenDemoActivity extends YouTubeFailureRecoveryActivity implements
  ...
  public void onInitializationSuccess(CustomYouTubePlayer.Provider provider, YouTubePlayer player,
    ...
    player.addFullscreenControlFlag(CustomYouTubePlayer.FULLSCREEN_FLAG_CUSTOM_LAYOUT);
  ...
  @Override
  protected CustomYouTubePlayer.Provider getYouTubePlayerProvider() {
    return playerView;
  }
  ...
  public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
    ...
    if (isChecked) {
      ...
      controlFlags |= CustomYouTubePlayer.FULLSCREEN_FLAG_ALWAYS_FULLSCREEN_IN_LANDSCAPE;
    } else {

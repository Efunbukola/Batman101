...
public class GoogleNavigationDrawer extends DrawerLayout {
    ...
    protected void onFinishInflate() {
        ...
        setListViewSections(mMainSections, mSecondarySections, mMainSectionsDrawableIds, mSecondarySectionsDrawableIds, 000000, 000000);
    }
     ...
     */
    public void setListViewSections(String[] mainSections, String[] secondarySections, int[] mainDrawableIds, int[] secondaryDrawableIds, int primaryTextColor, int secondaryTextColor) {
        if(!isInEditMode()) {
            if(mListView == null) {
                configureList();
            }
            GoogleNavigationDrawerAdapter adapter = new GoogleNavigationDrawerAdapter(getContext(), mainSections, secondarySections, mainDrawableIds, secondaryDrawableIds, primaryTextColor, secondaryTextColor);

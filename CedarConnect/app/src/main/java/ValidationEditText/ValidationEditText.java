...
public class ValidationEditText extends EditText implements OnFocusChangeListener{
	...
	private void initValidationEditText(){
		...
		if ( validationType != null ){
			...
			}else if ( validationType.equals("hu_id") ) {
                setRegex(ValidationType.VALIDATION_HU_ID);
            }else if ( validationType.equals("password") ) {
                setRegex(ValidationType.VALIDATION_PASSWORD);
            }else{
	...
	public void setRegex(int validationType) {
		switch(validationType){
			...
			case ValidationType.VALIDATION_NUMBER:
				...
				break;
            case ValidationType.VALIDATION_HU_ID:
                REGEX = ValidationRegularString.EMAIL;
                setInputType(InputType.TYPE_CLASS_TEXT);
                break;
            case ValidationType.VALIDATION_PASSWORD:
                REGEX = ValidationRegularString.PASSWORD;

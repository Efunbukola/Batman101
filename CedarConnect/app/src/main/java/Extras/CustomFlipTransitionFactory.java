 ...
 */
public class CustomFlipTransitionFactory extends BaseTransitionFactory {
     ...
     * Default constuctor
     */
    public CustomFlipTransitionFactory() {
     ...
     */
    public CustomFlipTransitionFactory(long duration) {
     ...
     */
    public CustomFlipTransitionFactory(long duration, Interpolator interpolator) {
     ...
     */
    public CustomFlipTransitionFactory(long duration, FlipAxis axis) {
     ...
     * @param interpolator The kind of interpolator we need
     */
    public CustomFlipTransitionFactory(long duration, Interpolator interpolator, FlipAxis axis) {
    ...
    public Animator getInAnimator(View target, SlideShowView parent, int fromSlide, int toSlide) {
        ...
        animator.setInterpolator(new JellyBounceInterpolator());  //Changed to Jelly Interpolator

...
import com.app.veed.veed.DynamicGridView.BaseDynamicGridAdapter;
import com.app.veed.veed.R;
import com.app.veed.veed.home_activity;
...
public class DynamicGridAdapter extends BaseDynamicGridAdapter {
    ...
    public DynamicGridAdapter(List<?> items, home_activity callingActivity, int mNumColumns,int item_height) {

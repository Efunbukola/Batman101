...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final int DEFAULT_MIN_FLING_VELOCITY = 700; // dips per second
    /**
    ...
    /**
     * No-op stubs for {@link com.app.veed.veed.SlidingUpPanelLayout.SlidingUpPanelLayout.PanelSlideListener}. If you only want to implement a subset

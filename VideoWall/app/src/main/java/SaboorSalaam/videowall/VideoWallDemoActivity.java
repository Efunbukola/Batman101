package SaboorSalaam.videowall;
...
public class VideoWallDemoActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        thumbnailView.initialize("AIzaSyCLGCJOPU8VVj7daoh5HwXZASnmGoc4ylo", this);
        ...
        playerFragment.initialize("AIzaSyCLGCJOPU8VVj7daoh5HwXZASnmGoc4ylo", this);
    ...
    @Override
    public void onInitializationFailure(
            CustomYouTubePlayer.Provider provider, YouTubeInitializationResult errorReason) {
        if (errorReason.isUserRecoverableError()) {
            if (errorDialog == null || !errorDialog.isShowing()) {
                errorDialog = errorReason.getErrorDialog(this, RECOVERY_DIALOG_REQUEST);
                errorDialog.show();
    ...
    private final class VideoListener implements CustomYouTubePlayer.PlayerStateChangeListener {
        ...
        @Override
        public void onError(CustomYouTubePlayer.ErrorReason errorReason) {
            if (errorReason == CustomYouTubePlayer.ErrorReason.UNEXPECTED_SERVICE_DISCONNECTION) {
